...
public static class Program
{
	...
	public static void ShowPlots()
	{
		...
		Charts.ShowPieChart(PieChartTask.GetTopFivePopularNameInYear(namesData, "1988"), "Топ 5 самых популярных имен в 1988 году");
		Charts.ShowPieChart(PieChartTask.GetTopFivePopularNameInYear(namesData, "1980"), "Топ 5 самых популярных имен в 1980 году");
		Charts.ShowPieChart(PieChartTask.GetTopFivePopularNameInYear(namesData, "1957"), "Топ 5 самых популярных имен в 1957 году");
		Charts.ShowPieChart(PieChartTask.GetTopFivePopularNameInYear(namesData, "1940"), "Топ 5 самых популярных имен в 1940 году");
	}
